<div class=" py-5">
    <div class="container">
        ...
        <div class="container text-start mb-5">
            ...
            <p class="fst-italic">
                Vous méritez un partenaire fiable pour sous-traiter vos missions comptables et ainsi offrir à vos clients un accompagnement irréprochable.
            </p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h4 class="card-title text-primary font-weight-bold">La passion du client</h4>
