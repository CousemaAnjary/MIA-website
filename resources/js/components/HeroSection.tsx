...
export default function HeroSection() {
    ...
    return (
        <>
            <div className="relative flex flex-col mt-16 md:mt-36 text-white px-4 md:px-16 lg:px-32 mx-auto">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center md:text-left">
                    Nous déléguer <br className="hidden md:block" /> une partie de vos activités <br className="hidden md:block" />c'est gagner du temps pour mieux accompagner vos précieux clients.
                </h1>
